...
class TestPermissionsOnCenterView(TestCase):
    ...
    def test_user_can_access_create_center_view(self):
        # Check unauthorized access
        response1 = self.c.get(reverse("center:create-center"))
        self.assertEqual(response1.status_code, 403)
        # Check authorized access
        self.user.user_permissions.add(
            Permission.objects.get(codename="add_center"))
        response2 = self.c.get(reverse("center:create-center"))
        self.assertEqual(response2.status_code, 200)

    def test_user_can_access_update_center_view(self):
        # Check unauthorized access
    ...
    def test_user_can_access_center_list_view(self):
        # Check unauthorized access
        response1 = self.c.get(reverse("center:center-list"))
        self.assertEqual(response1.status_code, 403)
        # Check authorized access
        self.user.user_permissions.add(
            Permission.objects.get(codename="view_center"))
        response2 = self.c.get(reverse("center:center-list"))
        self.assertEqual(response2.status_code, 200)

    def test_user_can_access_center_detail_view(self):
        # Check unauthorized access
        response1 = self.c.get(
    ...
    def test_user_can_access_delete_center_view(self):
        # Check unauthorized access
        response1 = self.c.get(
            reverse("center:center-delete", kwargs={"pk": self.center1.id}))
        self.assertEqual(response1.status_code, 403)
        # Check authorized access
        self.user.user_permissions.add(
...
class TestPermissionsOnStorageView(TestCase):
    ...
    def test_user_can_access_create_storage_view(self):
        # Check unauthorized access
        response1 = self.c.get(
    ...
    def test_user_can_access_update_storage_view(self):
        # Check unauthorized access
        response1 = self.c.get(
    ...
    def test_user_can_access_storage_list_view(self):
        # Check unauthorized access
        response1 = self.c.get(
    ...
    def test_user_can_access_storage_detail_view(self):
        # Check unauthorized access
        response1 = self.c.get(
    ...
    def test_user_can_access_delete_storage_view(self):
        # Check unauthorized access
        response1 = self.c.get(
