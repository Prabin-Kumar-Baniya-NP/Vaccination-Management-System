...
urlpatterns = [
    ...
    path(
        ...
        views.CreateStorage.as_view(),
        name="storage-create",
    ),
    path(
        "storage/update/<int:pk>/", views.StorageUpdate.as_view(), name="storage-update"
    ),
    path(
        "storage/delete/<int:pk>/", views.StorageDelete.as_view(), name="storage-delete"
    ),
]
