...
urlpatterns = [
    path("", views.VaccinationList.as_view(),
    ...
    path("choose-vaccine/", views.VaccineList.as_view(), name="choose-vaccine"),
    path("choose-campaign/<int:vaccine_id>/",
         views.CampaignList.as_view(), name="choose-campaign"),
    path("choose-slot/<int:campaign_id>/",
         views.SlotList.as_view(), name="choose-slot"),
    path("confirm-vaccination/<int:campaign_id>/<int:slot_id>/",
         views.ConfirmVaccination.as_view(), name="confirm-vaccination"),
    path("approve-vaccination/<int:vaccination_id>/",
         views.approve_vaccination, name="approve-vaccination"),
    path("appointment/<int:vaccination_id>/",
         views.appointment_letter, name="appointment-letter"),
